...
//? if <1.21.11
    /*private static final Map<UUID, ResourceLocation> SKIN_IDS     = new HashMap<>();
    */
...
//? if <1.21.11
    /*public static void store(UUID uuid, ResourceLocation skinId, boolean slim) {
    */
...
//? if <1.21.11
    /*public static ResourceLocation getLastSeenSkin(UUID uuid) {
    */
