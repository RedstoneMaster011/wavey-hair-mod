...
public class HairStrandManager {
    ...
    public List<StrandSimulation> getOrCreate(AbstractClientPlayerEntity player) {
    ...
    public static double[] computeRootWorld(AbstractClientPlayerEntity player, StrandOrigin origin) {
        BoneAnchor bone = BoneAnchor.from(origin.bone);
        double centerX = player.getX();
        double centerY = player.getY() + bone.centerYOffset;
        double centerZ = player.getZ();

        float yaw = (float) Math.toRadians(bone.usesHeadPitch ? player.getHeadYaw() : player.getBodyYaw());
